function [is_similar_index] = find_similar_derivative_pattern(derivative_array,index,cut_off_1,cut_off_2)
...
for i=index:-1:1
    ...
    for j=1:feature_size
        if current_derivative(j) > cut_off_1 && derivative_array(i,j) > cut_off_1
