function [clustering_index]=sequential_custom(data,cut_off_1,cut_off_2)
...
for i=2:number_of_points
    is_similar_index = find_similar_derivative_pattern(derivative_array,i-1,cut_off_1,cut_off_2);
