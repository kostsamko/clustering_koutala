...
plot_mineral_identification_mixed(all_data,data,A(:,5),image_clustered,'pyrochroite least squares',mean_array_clustered_mixed,std_array_clustered_mixed,clustering_data_index,number_of_mineral,true);
