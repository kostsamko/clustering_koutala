function [array_std_mean_abandance,array_std_mean_clustering] = plot_mineral_least_squares_no_barite(data,all_data,mineral_data,mineral_names,clustering_data,clustering_data_index,image_clustered)
...
[array_std_mean_abandance,array_std_mean_clustering] = plot_mineral_identification_mixed(all_data,data,A(:,4),image_clustered,'pyrochroite least squares',mean_array_clustered_mixed,std_array_clustered_mixed,clustering_data_index,number_of_mineral,true);
