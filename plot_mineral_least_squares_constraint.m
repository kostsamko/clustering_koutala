...
= plot_mineral_least_squares_constraint(data,all_data,mineral_data,mineral_names,clustering_data,clustering_data_index,image_clustered)
...
for i=1:number_of_clusters
    ...
    if sum(indexes) == 1
        mean_array_clustered_mixed_all(i,:) = result_array_all(indexes,:);
        std_array_clustered_mixed_all(i,:) = zeros(1,number_of_mineral);
        mean_array_clustered_mixed_eq(i,:) = result_array_eq(indexes,:);
        std_array_clustered_mixed_eq(i,:) = zeros(1,number_of_mineral);
        mean_array_clustered_mixed_uneq(i,:) = result_array_ueq(indexes,:);
        std_array_clustered_mixed_uneq(i,:) = zeros(1,number_of_mineral);
    else    
...
plot_mineral_identification_mixed(all_data,data,result_array_all(:,4),image_clustered,'barite all constraints',[],[],[],0,false);
[array_std_mean_abandance_all_constr,array_std_mean_clustering_all_constr] = plot_mineral_identification_mixed(all_data,data,result_array_all(:,5),image_clustered,'pyrochroite all constraints',mean_array_clustered_mixed_all,std_array_clustered_mixed_all,clustering_data_index,number_of_mineral,true);
...
plot_mineral_identification_mixed(all_data,data,result_array_eq(:,4),image_clustered,'barite eq constraint',[],[],[],0,false);
[array_std_mean_abandance_eq_constr,array_std_mean_clustering__eq_constr] = plot_mineral_identification_mixed(all_data,data,result_array_eq(:,5),image_clustered,'pyrochroite eq constraint',mean_array_clustered_mixed_eq,std_array_clustered_mixed_eq,clustering_data_index,number_of_mineral,true);
...
plot_mineral_identification_mixed(all_data,data,result_array_ueq(:,4),image_clustered,'barite uneq constraint',[],[],[],0,false);
[array_std_mean_abandance_uneq_constr,array_std_mean_clustering__uneq_constr] = plot_mineral_identification_mixed(all_data,data,result_array_ueq(:,5),image_clustered,'pyrochroite uneq constraint',mean_array_clustered_mixed_uneq,std_array_clustered_mixed_uneq,clustering_data_index,number_of_mineral,true);
